...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<%--<form:form action="/measuringsystem?${_csrf.parameterName}=${_csrf.token}" method="post"--%>
...
<%--</div>--%>
	...
	<c:forEach var="ms" items="${measuringsystems}">
		<li>${ms.name} <a href="/deleteMeasuringSystem/${ms.id}">delete</a>
			<a href="/updateMeasuringSystem/${ms.id}">update</a> </li>
	</c:forEach>
	</ol>
